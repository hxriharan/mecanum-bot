...
if("TRUE" STREQUAL "TRUE")
  set(mecanumbot_SOURCE_PREFIX /home/hariharan/mecanum_bot_ws/src/final_mecanumbot/mecanum-bot-dev(1)/mecanum-bot-dev)
  set(mecanumbot_DEVEL_PREFIX /home/hariharan/mecanum_bot_ws/devel/.private/mecanumbot)
  ...
  set(mecanumbot_INSTALL_PREFIX /home/hariharan/mecanum_bot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'omp <omp@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mecanumbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hariharan/mecanum_bot_ws/src/final_mecanumbot/mecanum-bot-dev(1)/mecanum-bot-dev/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mecanumbot_NUM_DUMMY_TARGETS)
      set(mecanumbot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mecanumbot::wrapped-linker-option${mecanumbot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mecanumbot_NUM_DUMMY_TARGETS "${mecanumbot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mecanumbot::wrapped-linker-option${mecanumbot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mecanumbot_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hariharan/mecanum_bot_ws/devel/.private/mecanumbot/lib;/home/hariharan/mecanum_bot_ws/devel/lib;/home/hariharan/mecanum_ws/devel/lib;/opt/ros/melodic/lib)
...
set(mecanumbot_EXPORTED_TARGETS "")
